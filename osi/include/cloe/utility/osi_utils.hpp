...
[[nodiscard]] int osi_identifier(const osi3::Identifier& osi_id);

/**
 * Convert osi3::Vector3d (x, y, z) into Eigen::Vector3d.
 */
[[nodiscard]] Eigen::Vector3d osi_vector3d_xyz_to_vector3d(const osi3::Vector3d& osi_coord);
 ...
 */
[[nodiscard]] Eigen::Vector3d osi_dimension3d_lwh_to_vector3d(const osi3::Dimension3d& osi_dim);

/**
 * Convert a osi3::Orientation3d (r, p, y) into Eigen::Vector3d.
 */
[[nodiscard]] Eigen::Vector3d osi_orientation3d_rpy_to_vector3d(const osi3::Orientation3d& osi_ori);
 ...
 */
template <typename T>
[[nodiscard]] Eigen::Isometry3d osi_position_orientation_to_pose(const T& osi_T);
