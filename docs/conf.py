...
# ones.
#
# Some day we might need sphinx.ext.imgmath.
extensions = [
    "sphinx.ext.todo",
    "sphinx.ext.graphviz",
...
# For options, see: https://www.sphinx-doc.org/en/master/usage/extensions/todo.html
...
# 'rainbow_dash', 'algol_nu', 'paraiso-light', 'trac', 'default', 'algol',
# 'fruity']
