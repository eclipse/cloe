...
- ``feature/JIRA-31337`` -- bad, "feature" tells us nothing new, and we don't
  want the indirection that "JIRA-31337" forces on us.
- ``teamx/JIRA-7944-add-timestamps-to-radar-objs`` -- good, "teamx" tells us
  the team responsible, and while "JIRA-7944" provides the link, the text
